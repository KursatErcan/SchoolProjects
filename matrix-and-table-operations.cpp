//A "Matrix and Table Operations" Program //
// Author      : Kürşat Ercan

//Matrix operasyonları için örnek çalışmarı içerir.
//Nesne yönelimli programlama dersi kapsamında ödev olarak yapılmıştır.
...
int main(){
	...
	int sec=1;
	  switch(sec){
	    ...
	    case 5 :{
	      Table<int> t1(4,4,1);
	      t1.print(); // satÄ±r ve sÃ¼tun etiketleri de yazilmali
	      cout<<endl;
	      string s[] = {"Sa1","Sa2"};
